    ...
    async handle(handlerInput) {
      ...
      if (accessToken == undefined){
        ...
        for(i=0; i<response.length; i++){
          ...
          var photos = response[i].photos;
          var id = response[i].id;
          var mapURL = helpers.generateMap(response[i].map.summary_polyline,process.env.GoogleMapsAPI);
          var achievementCard=''
          var achievementText=''   
          if(achievements >0){
        ...
        return handlerInput.responseBuilder
        .speak(speechText)
        //.withStandardCard(response[i].start_date_local.slice(0, 10), "Run name: "+runName+" \r\n Duration: "+runTime+" \r\n Distance: "+runDistance+" km \r\n Average Speed: "+runSpeed+"m \r\n", "Heart Rate: "+average_heartrate+" bpm "+achievementCard,'https://stravabot.s3.amazonaws.com/running.jpg')
        .withStandardCard(currentIntent.slots.date.value, "Run name: "+runName+" \r\n Duration: "+runTime+" \r\n Distance: "+runDistance+" km \r\n Average Speed: "+runSpeed+"m \r\n Heart Rate: "+average_heartrate+" bpm "+achievementCard,mapURL,mapURL)
        .getResponse();
      }
    }
};
    ...
    if (accessToken == undefined){
      ...
      return handlerInput.responseBuilder.speak(speechText).withLinkAccountCard().getResponse();
       ...
       // handlerInput.attributesManager.setSessionAttributes({"athleteID":id,"firstname":firstName});
        ...
        .withStandardCard("Year to Date", "Runs: "+response.ytd_run_totals.count+" \r\n Distance: "+distance+" km" + " \r\n Duration: "+moving_time+" \r\n Elevation gain: "+elevation_gain+"m",'https://stravabot.s3.amazonaws.com/running.jpg')
        .getResponse();
    }
  }
};
